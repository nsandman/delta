...
// each entry (of which there are 256) is 16 bytes. That should explain 
// a lot of the stuff I'm about to do.
idt_desc_t *idt;

// These are our ISR handlers, defined in interrupt.asm.
extern void isr0();
extern void isr1();
extern void isr2();
extern void isr3();
...
/*
 * This function is a bit weird since Pure64 already loads an IDT for us. So,
 * we use their table (which begins at 0x0000000000000000 and ends at
 * 0x0000000000000fff). Also, we use n*16 as the address because each entry is
